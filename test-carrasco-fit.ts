async function testCarrascoFit() {
  const apiKey = "AIzaSyAlPByjWib136gM6pLS68hEnuFQVhgIidE";
  const projectId = "carrasco-fit-607856914066";
  
  const ids = ["(default)", "ai-studio-c02d96e6-2cfd-4c61-9d84-8d2be7a4efd6", "carrasco-data-final", "carrasco-data-1"];
  
  for (const db of ids) {
    console.log(`\n--- Testing REST for Project ${projectId} DB: ${db} ---`);
